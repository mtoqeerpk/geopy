...
class importpsseissegy(object):
    ...
    def setupGUI(self, ImportPsSeisSegy):
        ...
        ImportPsSeisSegy.setFixedSize(480, 200)
        icon = QtGui.QIcon()
        ...
        self.btnimport.setGeometry(QtCore.QRect(160, 140, 160, 30))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(self.iconpath, "icons/segy.png")),
                       QtGui.QIcon.Normal,
                       QtGui.QIcon.Off)
    ...
    def clickBtnImport(self):
        ...
        for i in range(_nfile):
            ...
            _psseisdata[_filenamemain] = psseis_io.readPsSeisFromSegy(_filename, qpgsdlg=_pgsdlg)
            #
